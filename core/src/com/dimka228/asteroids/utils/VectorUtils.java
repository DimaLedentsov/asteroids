...
public class VectorUtils {
    public static Vector2 fromAngle(float angle, float m) {
        return new Vector2(MathUtils.cos(angle) * m, MathUtils.sin(angle) * m);
    }
...
/*/
    ...
    public static Vector2 randomVector(float min, float max){
        return fromAngle(RandomUtils.randomBetween(0,MathUtils.PI*2), RandomUtils.randomBetween(min, max));
    }
    ...
    public static Vector2 toView(Vector2 v){
        return v.cpy().scl(Game.WORLD_TO_VIEW);
    }
